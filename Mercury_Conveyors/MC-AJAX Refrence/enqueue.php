...
function load_css() {
  ...
  wp_enqueue_style("aoscss",get_template_directory_uri()."/resources/aos.css");
}
...
function load_js() {
  ...
  wp_enqueue_script("aosjs",get_template_directory_uri()."/resources/aos.js",array(),null,true);
